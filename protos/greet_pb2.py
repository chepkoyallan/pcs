...
_GREETING = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      name='second_name', full_name='greet.Greeting.second_name', index=1,
